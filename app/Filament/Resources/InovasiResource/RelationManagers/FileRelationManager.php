...
namespace App\Filament\Resources\InovasiResource\RelationManagers;
...
{
    protected static string $relationship = 'file'; // Nama relasi di model

    protected static ?string $title = 'Dokumen Inovasi'; // Judul Relation Manager
